...
- [Task Class](#task-class)
  - [Task.add_task](#taskadd_task)
  - [Task.complete_task](#taskcomplete_task)
  - [Task.give_up_task](#taskgive_up_task)
  - [Task.freeze_task](#taskfreeze_task)
  - [Task.unfreeze_task](#taskunfreeze_task)
  - [Task.delete_task](#taskdelete_task)
- [Shop Class](#shop-class)
  - [Shop.add_item](#shopadd_item)
  - [Shop.add_item](#shopedit_item)
  - [Shop.add_item](#shopuse_item)
  - [Shop.add_item](#shopedit_loot_box)
- [ATM Class](#atm-class)
  - [ATM.deposit](#atmdeposit)
  - [ATM.withdraw](#atmwithdraw)
- [Pomodoro Class](#pomodoro-class)
  - [Pomodoro.add_record](#pomodoroadd_record)
  - [Pomodoro.edit_pomodoro](#pomodoroedit_pomodoro)
## Getting Started
