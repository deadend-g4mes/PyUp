...
def reward(content: str, type: str, number: int, skills: list = None, item_id: int = None, item_name: str = None, silent: bool = None) -> Response:
    '''
...
def toast(text: str, type: int = 0, isLong: bool = False) -> Response:
    '''
...
def penality(content: str, type: str, number: int, skills: list = None, item_id:int = None, item_name: str = None, silent: bool = None) -> Response:
    '''
